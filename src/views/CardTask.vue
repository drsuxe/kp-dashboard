    ...
    <mp-box>
      ...
      >
        <mp-tab-list>
          <mp-tab>
            ...
            <mp-badge
              ml="2"
              variant="subtle"
              :variant-color="currentTab === 0 ? 'blue' : 'gray'"
            >
              9+
            </mp-badge>
          </mp-tab>
          <mp-tab>
            ...
            <mp-badge
              ml="2"
              variant="subtle"
              :variant-color="currentTab === 1 ? 'blue' : 'gray'"
            >
              9+
            </mp-badge>
          </mp-tab>
          <mp-tab>
            ...
            <mp-badge
              ml="2"
              variant="subtle"
              :variant-color="currentTab === 2 ? 'blue' : 'gray'"
            >
              1
            </mp-badge>
          </mp-tab>
          <mp-tab>
            ...
            <mp-badge
              ml="2"
              variant="subtle"
              :variant-color="currentTab === 3 ? 'blue' : 'gray'"
            >
              1
            </mp-badge>
          </mp-tab>
        ...
        <mp-tab-panels>
          ...
          <mp-tab-panel>
            <mp-box
              v-if="currentTab === 0 && status === 'active'"
              overflow-x="auto"
            >
              <mp-table>
                <mp-table-head>
                  <mp-table-row
                    v-if="
                      (isIndeterminate && useCheckbox) ||
                      (isCheckedAll && useCheckbox)
                    "
                  >
                    ...
                    <mp-table-cell as="th" scope="col" colspan="5">
                      <mp-flex gap="6" alignItems="center">
                        <mp-text fontWeight="semibold">
                          2 ID Billing dipilih
                        </mp-text>
                        <mp-button> Bayar sekaligus </mp-button>
                        <mp-button @click="handleUncheckAll()" variant="ghost">
                          Batalkan pilihan
                        </mp-button>
                      </mp-flex>
                    </mp-table-cell>
                  ...
                  <mp-table-row v-else>
                    ...
                    <mp-table-cell as="th" scope="col"
                      >ID Billing</mp-table-cell
                    >
                    <mp-table-cell as="th" scope="col"
                      >Jenis pajak</mp-table-cell
                    >
                    <mp-table-cell as="th" scope="col"
                      >Kedaluwarsa</mp-table-cell
                    >
                    <mp-table-cell as="th" scope="col"
                      >Jumlah pajak</mp-table-cell
                    >
                  ...
                  >
                    <mp-table-cell v-if="useCheckbox" as="td" scope="row">
                      <mp-checkbox
                        ...
                        v-model="source[index].isChecked"
                        :is-checked="value.isChecked"
                      />
                    </mp-table-cell>
                    ...
                    <mp-table-cell as="td" scope="row">
                      <mp-popover
                        v-if="value.isDropdown"
                        :id="`e-billing-popover-${value.id}`"
                        ref="eBillingPopover"
                      >
                        <mp-popover-trigger>
                          <mp-button
                        ...
                        >
                          ...
                          >
                            <mp-popover-list-item @click="closePopover(index)"
                              >Pilih metode pembayaran</mp-popover-list-item
                            >
                            <mp-popover-list-item @click="closePopover(index)"
                              >Konfirmasi NTPN</mp-popover-list-item
                            >
                          </mp-popover-list>
                        </mp-popover-content>
                      </mp-popover>
              ...
              <mp-box padding-x="2" padding-y="4">
                <mp-flex justify-content="space-between">
                  <mp-flex align-items="center">
                    <mp-text color="gray.600" line-height="md" padding-y="1">
                      Menampilkan 5 dari 10
                    </mp-text>
                  </mp-flex>
                  <mp-flex align-items="center">
            ...
            >
              ...
              <mp-text font-weight="semibold">
                Tidak ada transaksi yang perlu diselesaikan
              </mp-text>
            </mp-flex>
          </mp-tab-panel>
              ...
              <mp-table>
                <mp-table-head>
                  ...
                  <mp-table-row v-else>
                    ...
                    <mp-table-cell as="th" scope="col"
                      >Nomor faktur</mp-table-cell
                    >
                    <mp-table-cell as="th" scope="col">Pelanggan</mp-table-cell>
                    <mp-table-cell as="th" scope="col"
                      >Status approval</mp-table-cell
                    >
                    <mp-table-cell as="th" scope="col"
                      >Jumlah PPN</mp-table-cell
                    >
                    <mp-table-cell as="th" scope="col">Tindakan</mp-table-cell>
                  </mp-table-row>
                </mp-table-head>
              ...
              <mp-table>
                <mp-table-head>
                  <mp-table-row>
                    ...
                    <mp-table-cell as="th" scope="col"
                      >Masa Pajak</mp-table-cell
                    >
                    <mp-table-cell as="th" scope="col"
                      >Pembetulan</mp-table-cell
                    >
              ...
              <mp-table>
                <mp-table-head>
                  <mp-table-row>
                    ...
                    >
                    <mp-table-cell as="th" scope="col"
                      >Jumlah PPh Pasal 23/26 kurang disetor</mp-table-cell
                    >
                    <mp-table-cell as="th" scope="col">Status</mp-table-cell>
                    <mp-table-cell as="th" scope="col">Tindakan</mp-table-cell>
                  </mp-table-row>
